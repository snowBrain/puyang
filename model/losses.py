...
###############################################################################
# Functions  Contentloss内容损失   PerceptualLoss感知损失
###############################################################################
...
class PriorLoss(nn.Module):
	...
	def get_loss(self, net, fakeIm, realIm):
		realIm_no_grad = realIm.detach()
		loss = self.criterion(fakeIm, realIm_no_grad)
		return loss
...
def init_loss(opt, tensor):
	...
	prior_loss.initialize(nn.MSELoss())

	return disc_loss, perceptual_loss, content_loss, prior_loss
